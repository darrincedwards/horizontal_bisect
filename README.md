...
- Each feature branch is believed to be individually coherent (has the bug being sought or not, without an unrelated exception)
...
- No attempt is made to remove the `horizontal_bisect_control.txt` file (or
